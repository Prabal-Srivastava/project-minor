    ...
    <div className="py-12 flex items-start justify-center">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-2">Admin Forgot Password</h2>
          <p className="text-gray-500">Enter your admin email to receive a password reset link</p>
        </div>
        {error && (
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-900">Admin Email Address</label>
              <input
                type="email"
                value={email}
